...
# os.environ['CUDA_VISIBLE_DEVICES'] = '0' # set the GPU ids
import time
import mmcv
import torch
...
warnings.filterwarnings("ignore", category=UserWarning, module="openselfsup.models.utils.position_encoding")
...
def main():
    ...
    cfg.data.train['my_transform'] = cfg.my_transform
